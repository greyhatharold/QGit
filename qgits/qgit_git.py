...
class GitCommand:
    ...
    def run(command: str, check: bool = True) -> str:
        ...
        try:
            ...
            if any(s in error_msg.lower() for s in ['network', 'connection refused', 'ssh', 'timeout']):
                error_type = "network"
            ...
            elif any(s in error_msg.lower() for s in ['index locked', 'head locked', 'ref locked']):
                error_type = "state"
    ...
    @classmethod
    def push(cls, remote: str = "origin", branch: Optional[str] = None,
    ...
    @classmethod
    def stash(cls, message: Optional[str] = None, 
    ...
    @classmethod
    def get_diff(cls, staged: bool = False, 
